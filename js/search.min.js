        ...
        <article class="politician-card ${e.usesX?"on-x":"not-on-x"}">
          ...
          <ul>
            ...
            <li><strong>On X:</strong> 
                  ${e.usesX&&e.xHandle?`<a href="https://x.com/${e.xHandle.replace("@","")}" target="_blank" rel="noopener noreferrer">
                ${e.xHandle}</a>`:"No"}
            </li>
