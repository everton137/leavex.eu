(()=>{(function(){const i=document.getElementById("politician-search"),l=document.getElementById("politician-list"),d=document.getElementById("filter-level"),t=document.getElementById("filter-country"),u=document.getElementById("filter-xstatus"),s=document.getElementById("politician-stats");if(!l||!i||!u||!s){console.warn("Required elements not found (list/search/status/stats).");return}const A=window.PAGE_TITLE?window.PAGE_TITLE.replace(/^["“]|["”]$/g,""):"",h=!!d,m=!!t,r=window.POLITICIANS||[];let e=[];if(Array.isArray(r))e=r;else if(typeof r=="string")try{const t=JSON.parse(r);Array.isArray(t)&&(e=t)}catch(e){console.warn("Failed to parse POLITICIANS JSON string:",e)}const c=document.getElementById("email-tools");function v(e){return String(e||"").trim().toLowerCase()}function _(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}function k(e){const t=new Set;return e.forEach(e=>{const n=v(e.email);n&&_(n)&&t.add(n)}),Array.from(t)}function E(e,t){const n=[];for(let s=0;s<e.length;s+=t)n.push(e.slice(s,s+t));return n}async function w(e){if(navigator.clipboard&&window.isSecureContext){await navigator.clipboard.writeText(e);return}const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.left="-9999px",document.body.appendChild(t),t.focus(),t.select(),document.execCommand("copy"),document.body.removeChild(t)}function n(e){const t=(e.xStatus||"").toLowerCase();return t==="active"||t==="inactive"||t==="none"||t==="unknown"?t:e.usesX===!0?"active":e.usesX===!1?"none":"unknown"}function b(e){const t=n(e);return t==="inactive"?"x-inactive":t==="active"?"x-active":t==="none"?"x-none":"x-unknown"}function j(e,t){if(!t)return!0;const s=n(e);return t==="active"||t==="inactive"||t==="none"?s===t:t==="on"?s==="active":t!=="off"||s==="none"}function y(e){const t=n(e),i=e.xHandle?` (${e.xHandle})`:"";let s="Status unknown";t==="active"?s="Still active on X":t==="inactive"?s="Has X, but is inactive":t==="none"&&(s="Not on X"),t==="inactive"&&e.xLastArchiveUrl&&(s+=` - <a href="${e.xLastArchiveUrl}" class="link-primary" target="_blank" rel="noopener noreferrer">see exit post</a>`);const a=e.xHandle&&(t==="active"||t==="inactive")?`<a href="https://x.com/${e.xHandle.replace("@","")}" class="link-primary" target="_blank" rel="noopener noreferrer">${e.xHandle}</a>`:"",o=a||i;return`
      <li>
